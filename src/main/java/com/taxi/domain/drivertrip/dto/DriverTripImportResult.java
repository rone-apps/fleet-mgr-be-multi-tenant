...
public class DriverTripImportResult {
    ...
    public List<String> getDuplicateJobIds() { return duplicateJobIds; }
    public void setDuplicateJobIds(List<String> duplicateJobIds) { this.duplicateJobIds = duplicateJobIds; }
